...
test_that("modify_mod works", {
  ...
  expect_equal(attr(modify_mod(mod, tab, pred = 0), 'warning'), gettext("glm.fit: fitted probabilities numerically 0 or 1 occurred"))
  ...
  expect_equal(attr(modify_mod(mod, tabm, pred = 0), 'warning'), gettext("glm.fit: fitted probabilities numerically 0 or 1 occurred"))
})
